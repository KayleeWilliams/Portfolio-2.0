  ...
  <div
    ...
    <div class="flex flex-col gap-6 text-2xl items-center w-full">
      ...
      <div class="flex flex-row flex-wrap">
        ...
        <MdiLanguageHtml5 class="w-12 h-12 basis-1/3 mb-12" />
        <MdiLanguageCss3 class="w-12 h-12 basis-1/3 mb-12" />
        <MdiVuejs class="w-12 h-12 basis-1/3" />
        <MdiNodejs class="w-12 h-12 basis-1/3" />
        <SimpleIconsFigma class="w-12 h-12 basis-1/3" />
      </div>
    </div>
  </div>
</template>
