<template>
    <div class="h-screen w-full flex flex-col gap-16 items-center justify-center text-center leading-tight text-2xl md:text-3xl">
        <p class="font-bold text-4xl md:text-6xl"> Contact Me! </p>
